...
const CartPage = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 bg-white mt-17">
        ...
        <>
          ...
          <div className="mt-6 flex justify-between items-center">
            ...
            <div className="text-right">
              ...
              <button type="submit" onClick={()=>handleCheckout()} className="mt-3 bg-red-500 text-white py-2 px-6 rounded-lg hover:bg-red-600 transition">
                Proceed to Checkout
              </button>
            </div>
          </div>
      ...
      {
        checkout && (
          <Checkout onClose={()=>setCheckout(false)}/>
        )
      }
    </div>
  );
